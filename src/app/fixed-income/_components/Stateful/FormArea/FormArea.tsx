      ...
      <form onSubmit={handleSubmit}>
        <FormAreaLayout>
          <div className='flex flex-wrap md:flex-nowrap gap-4 md:gap-20 items-center'>
            ...
            <MonthInput name='period' label={`Number of ${period.label}`} value={formStates.period} id='monthInput' onChange={handleOnChange} />
          </div>
          <PercentageGroupLayout>
            <PercentageInput name='cdiPercentage' label='CDI Percentage' value={formStates.cdiPercentage} id='cdiInput' onChange={handleOnChange} />
            <PercentageInput name='selicPercentage' label='Selic Percentage' value={formStates.selicPercentage} id='selicInput' onChange={handleOnChange} />
          </PercentageGroupLayout>
