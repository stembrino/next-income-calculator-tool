...
// t: time
// M: final value
function calculate({ i, C, t, percentage }: { i: number, C: number, t: number, percentage: number }) {
...
export function calculateCompoundInterestRate(timeUnit: PeriodKeys, { initialValue, percentage, period, unitValues }: CalculateParams): number {
  if (!unitValues["a.d."] || !unitValues["a.m."] || !unitValues["a.a."]) throw new Error("calculateCompoundInterestRate ~ calculateCompoundInterestRate was not provided.");
